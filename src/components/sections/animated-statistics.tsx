  ...
  return (
    <section ref={sectionRef} className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold tracking-tight mb-2">By the Numbers</h2>
        <p className="text-muted-foreground mb-8">A snapshot of my professional journey and technical expertise.</p>
